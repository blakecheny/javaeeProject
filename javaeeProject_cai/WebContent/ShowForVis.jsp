...
<title>Welcome to Lab Show For Visitors</title>
</head>
<body>
<div id="container">
	...
	<div id="content">
		<div id="lab">
			...
			<div id="input1">
				...
				<select name="sel">
					<option value="hao">号牌</option>
					<option value="ming">名称</option>
					<option value="all">全部</option>
					<option value="fuz">模糊查询</option>
				</select><br/>
		...
		<div id="device">
			...
			<div id="mesg2">
				<div id="table">
				<table>
					<tr id="title2"><th colspan="6">设备信息</th></tr>
					<tr>
						<th>从属实验室</th>
						<th>设备号</th>
						<th>类型</th>
				...
				共<%=intRowCount%>个记录，分<%=intPageCount%>页显示/当前第<%=intPage%>页     <%
						for (int j = 1; j <= intPageCount; j++) {
								out.print("&nbsp;&nbsp;<a href='ShowForVis.jsp?page=" + j + "'>"
										+ j + "</a>");			//此处设置了page参数
							}
					%></td>
					</tr>
